...
public class UploadController {
  ...
  @RequestMapping(value = "board/subOption.htm", method = RequestMethod.POST)
  public String subOption(Model model, String temp) throws Exception {
	  System.out.println("AJAX subOption 컨트롤러 접속 ");
	  System.out.println("카테코드"+temp);
	  System.out.println(service.getSubCateList(temp));
	  
	  
	  model.addAttribute("SubCateList", service.getSubCateList(temp));
	  return "common/subOption";
  }

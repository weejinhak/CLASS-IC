...
<div class="content">
	...
	<div class="col-md-12">
                            <div class="card">
                            <form method="post" action="updateHomework.htm" class="form-horizontal" name="frm" id="frm">
                                        ...
                                        <div class="row">
                                        	<div class="td-actions text-center">
												<button type="button" rel="tooltip"
													class="btn btn-success btn-round" id="update" name="update">
												...
												<button type="button" rel="tooltip" class="btn">
													<i class="material-icons" id="delete" name="delete">delete</i>
												</button>
											</div>
...
$("#frm").submit(function(event) {
	...
	var assignTitle = $("#assignTitle").val(); //제목
	var assignContent = $("#assignContent").val(); //내용

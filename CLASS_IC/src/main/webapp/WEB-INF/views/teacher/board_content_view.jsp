						...
						<div class="card-content">
							...
							<div class="row">
								...
								<div class="col-sm-10">
									...
									<input type="text" class="form-control"
										value="${LectureBoardDTO.lectureTitle}" style="width: 90%"
										readonly="readonly">
							...
							<div class="row">
								...
								<div class="col-sm-10">
									<div class="form-group label-floating is-empty">
										<label class="control-label"></label>
										<textarea cols="50"
											style="width: 90%; height: 300px; color: gray"
											readonly="readonly">${LectureBoardDTO.lectureContent}</textarea>
									...
									<li><span class="mailbox-attachment-icon"><i
										...
										<div class="mailbox-attachment-info">
											<a href="#" class="mailbox-attachment-name"> <i
												class="fa fa-paperclip"></i> ${LectureBoardDTO.fileTitle}
											</a> <span class="mailbox-attachment-size"> 1,245 KB </span>
										</div></li>
									<li><span class="mailbox-attachment-icon"><i
											class="fa fa-file-pdf-o"></i></span>
										...
										<div class="mailbox-attachment-info">
											<a href="#" class="mailbox-attachment-name"> <i
												class="fa fa-paperclip"></i> Sep2014-report.pdf
											</a> <span class="mailbox-attachment-size"> 1,245 KB </span>
										</div></li>
									<li><span class="mailbox-attachment-icon"><i
							...
							<div class="col-sm-5">
								...
								<ul class="mailbox-attachments clearfix">
									...
									<li>링크 URL:<a href="${LectureBoardDTO.linkSrc}">${LectureBoardDTO.linkSrc}</a>
									</li>
									<br>
									<li>링크 제목:</li>
									<li>링크 URL:</li>
					...
					<div class="td-actions text-center">
						...
						<form action="teacher/totalLectureBoard">
							<button type="submit" rel="tooltip"
								class="btn btn-info btn-round" id="list" name="list" style="">
								<i class="material-icons">list</i>
							</button>
						</form>

						<form action="teacher/totalLectureBoard_Edit">
							<button type="submit" rel="tooltip"
								class="btn btn-success btn-round" id="edit" name="edit">
